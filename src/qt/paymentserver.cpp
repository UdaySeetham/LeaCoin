...
const QString BITCOIN_IPC_PREFIX("leacoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click leacoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start leacoin: click-to-pay handler");
    else
...
{
    // clicking on leacoin: URLs creates FileOpen events on the Mac:
